...
[들쭉날쭉 인천 버스…전국 최하 수준에 시민들 ‘답답’](https://v.daum.net/v/YIVzeLHRKq?f=p)

전국에서 인천의 노선 굴곡도 최악, 버스의 배차 간격 또한 최악인 수준입니다.

노선 굴곡도를 줄여 불필요한 버스 운행을 줄입니다. 동시에 전체 이용객을 수용하는 데 문제가 없도록 설계합니다.

# 프로젝트 결과

이용객의 3% 손실이 있는 대신, 전체 노선 길이가 40% 줄어들었습니다.

만약 줄어든 40%를 모두 배차 간격을 줄이는 데 사용하면, 노선 굴곡도와 배차 간격이 전국 상위권을 기대할 수 있습니다.
